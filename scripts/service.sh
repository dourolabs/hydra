...
SERVER_IMGUR_CLIENT_ID="${SERVER_IMGUR_CLIENT_ID:-${IMGUR_CLIENT_ID:-}}"
SERVER_IMGUR_ACCESS_TOKEN="${SERVER_IMGUR_ACCESS_TOKEN:-${IMGUR_ACCESS_TOKEN:-}}"
SERVER_IMGUR_API_BASE_URL="${SERVER_IMGUR_API_BASE_URL:-https://api.imgur.com}"
...
[imgur]
client_id = "${SERVER_IMGUR_CLIENT_ID}"
access_token = "${SERVER_IMGUR_ACCESS_TOKEN}"
api_base_url = "${SERVER_IMGUR_API_BASE_URL}"

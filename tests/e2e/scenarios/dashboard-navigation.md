...
2. Verify the main landing page (Dashboard) loads with the icon sidebar visible
   - Sidebar should show Dashboard, Chat, Documents, and Settings navigation icons
...
5. Navigate to the **Chat** page (`/chat`) via the sidebar
...
7. Navigate to the **Settings** page (`/settings`) via the sidebar
...
8. Take a screenshot of each page for visual verification

## Expected Results

- All key pages load without errors: Dashboard (issues list), issue detail, Chat (conversations list), documents, and settings

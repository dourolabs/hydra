...
use hydra_common::{BuildCacheContext, BuildCacheStorageConfig};
...
) -> Result<Arc<dyn hydra_build_cache::StorageClient>> {
    match storage {
        BuildCacheStorageConfig::FileSystem { root_dir } => {
            let config = hydra_build_cache::FileSystemStorageConfig {
        ...
        BuildCacheStorageConfig::S3 {
            ...
            let config = hydra_build_cache::S3StorageConfig {

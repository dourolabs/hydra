...
async fn document_operations_through_worker() -> Result<()> {
    ...
    let repo = hydra_common::RepoName::from_str("acme/doc-ops")?;
    ...
    let query = hydra_common::documents::SearchDocumentsQuery::new(
    ...
    // Fetch full document to verify body_markdown

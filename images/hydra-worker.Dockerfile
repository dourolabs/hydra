...
RUN bash -c "source $NVM_DIR/nvm.sh && nvm install $NODE_VERSION && npm install -g @openai/codex @anthropic-ai/claude-code puppeteer playwright@1.58.2 @anthropic-ai/mcp-playwright pnpm"

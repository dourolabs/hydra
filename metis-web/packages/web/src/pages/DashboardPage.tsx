...
export function DashboardPage() {
  ...
  const inboxCount = Math.max(0, inboxOpenCount + inboxInProgressCount - inboxActiveCount);
  const myIssuesCount = Math.max(0, myIssuesOpenCount + myIssuesInProgressCount - myIssuesActiveCount);

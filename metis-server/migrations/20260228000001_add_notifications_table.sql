...
CREATE TABLE IF NOT EXISTS metis.notifications (
...
CREATE INDEX IF NOT EXISTS idx_notifications_object
    ON metis.notifications (object_id, object_version);

...
pub struct MetisPod {
    /// The Metis job ID associated with the pod.
    pub id: MetisId,
...
pub trait JobEngine: Send + Sync {
    ...
    /// Lists all pods associated with Metis jobs.
    ///
    /// # Returns
    /// A vector of MetisPod resources matching the selector

...
impl From<api::identity::Username> for Username {
    fn from(value: api::identity::Username) -> Self {
        Username(value.into())
    }
}

impl From<Username> for api::identity::Username {
    fn from(value: Username) -> Self {
        api::identity::Username::from(value.0)
    }
}
...
mod tests {
    ...
    fn username_converts_between_domain_and_api() {
        ...
        let api_value: api::identity::Username = domain.clone().into();

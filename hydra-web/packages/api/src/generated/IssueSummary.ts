...
import type { ActorPrincipal } from "./ActorPrincipal";
 ...
 */
export type IssueSummary = { type: IssueType, title: string, description: string, creator: Username, status: IssueStatus, assignee?: ActorPrincipal | null, progress: string, dependencies: Array<IssueDependency>, patches: Array<PatchId>, todo_list?: Array<TodoItem>, deleted?: boolean, labels?: Array<LabelSummary>, };

...
function FolderNode({ entry, depth }: FolderNodeProps) {
  ...
  return <ExpandableFolderNode entry={entry} depth={depth} isDocAndFolder={isDocAndFolder} />;
}

function ExpandableFolderNode({ entry, depth, isDocAndFolder }: FolderNodeProps & { isDocAndFolder: boolean }) {

...
CREATE TABLE IF NOT EXISTS metis.label_associations (
    label_id TEXT NOT NULL REFERENCES metis.labels(id),
...
CREATE INDEX IF NOT EXISTS label_associations_object_idx
    ON metis.label_associations (object_id);
CREATE INDEX IF NOT EXISTS label_associations_label_idx
    ON metis.label_associations (label_id);

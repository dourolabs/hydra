...
ALTER TABLE hydra.user_secrets ADD COLUMN internal BOOLEAN NOT NULL DEFAULT FALSE;

-- Mark existing system-internal secrets as internal.
UPDATE hydra.user_secrets SET internal = TRUE WHERE secret_name IN ('GITHUB_TOKEN', 'GITHUB_REFRESH_TOKEN');

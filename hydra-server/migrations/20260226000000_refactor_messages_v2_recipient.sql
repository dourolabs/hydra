...
ALTER TABLE hydra.messages_v2 ADD COLUMN IF NOT EXISTS recipient TEXT;

-- Step 2: Make sender nullable
ALTER TABLE hydra.messages_v2 ALTER COLUMN sender DROP NOT NULL;
...
ALTER TABLE hydra.messages_v2 ALTER COLUMN recipient SET NOT NULL;

-- Step 5: Add index on recipient
CREATE INDEX IF NOT EXISTS idx_messages_v2_recipient ON hydra.messages_v2 (recipient);
...
DROP INDEX IF EXISTS hydra.idx_messages_v2_conversation;
ALTER TABLE hydra.messages_v2 DROP COLUMN IF EXISTS conversation_id;
